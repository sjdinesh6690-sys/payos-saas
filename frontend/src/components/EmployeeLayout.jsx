...
const NAV = [
  { to: '/employee',          icon: FileText, label: 'My Payslips', end: true },
  { to: '/employee/profile',  icon: User,     label: 'My Profile',  end: false },
];
    ...
    <div className="flex h-screen bg-zoho-bg">
      <aside className="w-56 bg-white border-r border-zoho-border flex flex-col shrink-0">
        <div className="px-5 py-5 border-b border-zoho-border">
          ...
          <p className="text-xs text-zoho-muted">Employee Portal</p>
        </div>
